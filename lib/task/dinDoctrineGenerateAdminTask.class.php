 ...
 * @version    SVN: $Id: dinDoctrineGenerateAdminTask.class.php 49 2010-07-01 18:29:15Z relo_san $
 */
class dinDoctrineGenerateAdminTask extends sfDoctrineBaseTask
{
  /**
   * @see sfTask
   */
  protected function configure()
  {
    ...
    $this->addOptions(array(
      ...
      new sfCommandOption('plugin', null, sfCommandOption::PARAMETER_REQUIRED, 'Plugin name', null),
...
EOF
  ...
  protected function generateForRoute($arguments, $options)
  {
    ...
    $task = new dinDoctrineGenerateModuleTask($this->dispatcher, $this->formatter);
